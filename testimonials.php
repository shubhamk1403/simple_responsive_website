                ...
                <nav>
                  <ul class="nav topnav">
					...
					<li class="dropdown active">
                      <a href="testimonials.php">Clients</a>
                    </li>
					<li class="dropdown">
    ...
    <section id="content">
      <div class="container">
        <div class="row marginbot30">
          <div class="span12">
            <h4 class="heading"><strong>Clients</strong> and what they say<span></span></h4>
            <div class="row">
              <div class="span6">
                <div class="wrapper">
                  <div class="testimonial">
                    <p class="text">
                      <i class="icon-quote-left icon-48"></i> It’s better than having your own IT staff. They are extremely responsive, and quick to cure problems.
                    </p>
                    <div class="author">
                      ...
                      <span class="info">Probat Burns, <a href="#">www.probat.com</a></span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="span6">
                <div class="wrapper">
                  <div class="testimonial">
                    <p class="text">
                      <i class="icon-quote-left icon-48"></i> We were told by a client that the decision to use our firm was based on the website Links built us. A great site does win clients!
                    </p>
                    <div class="author">
                      <img src="img/dummies/testimonial-author1.png" class="img-circle bordered" alt="" />
                      <p class="name">
                      ...
                      <span class="info">Health Environment Art Services, <a href="#">www.heathenvironment.com</a></span>
                    </div>
                  </div>
                </div>
              </div>
