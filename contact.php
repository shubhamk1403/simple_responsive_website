              ...
              <div class="modal-body">
                <form action="" class="form-horizontal" method="post" role="form">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="email" class="form-control" id="inputEmail" placeholder="Email" data-rule="email" data-msg="Please enter a valid email">
                    </div>
                  </div>
                  <div class="control-group">
          ...
          <div class="span3">
            <div class="widget">
              ...
              <ul class="link-list">
                ...
                <li><a href="portfolio">Explore our portfolio</a></li>
