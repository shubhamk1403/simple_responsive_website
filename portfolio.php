              ...
              <section id="projects">
                <ul id="thumbs" class="portfolio">
                  ...
                  <li class="item-thumbs span3 design" data-id="id-0" data-type="web">
                    ...
                    <img src="img/works/thumbs/image-01.jpg" alt="RDC Fine Homes specializes in building and renovating custom homes throughout the Sea-to-Sky Corridor and on the North Shore of British Columbia. Leaders in high-performance building technology, RDC Fine Homes continually strives to improve construction practices and project management systems.">
                  </li>
                  <!-- End Item Project -->
                  <!-- Item Project and Filter Name -->
